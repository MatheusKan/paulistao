...
<?php
    ...
    $qtdeJogos = $_POST['qtdeJogos'];
    $qtdeVitorias = $_POST['qtdeVitorias'];
    $qtdeEmpates = $_POST['qtdeEmpates'];
    $qtdeDerrotas = $_POST['qtdeDerrotas'];   
	...
	$res = mysqli_query($con,"insert into paulista values ($idtime, '$nometime', $qtdeJogos, $qtdeVitorias, $qtdeEmpates,  $qtdeDerrotas ,$classificacao)");
